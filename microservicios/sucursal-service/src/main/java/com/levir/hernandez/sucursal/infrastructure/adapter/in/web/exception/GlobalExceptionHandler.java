package com.levir.hernandez.sucursal.infrastructure.adapter.in.web.exception;

import com.levir.hernandez.sucursal.application.exception.RecursoNoEncontradoException;
import com.levir.hernandez.sucursal.application.exception.ServicioNoDisponibleException;
import com.levir.hernandez.sucursal.domain.exception.DomainException;
import com.levir.hernandez.sucursal.infrastructure.adapter.in.web.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler
{
    ...
    public ResponseEntity<ErrorResponse> servicioNoDisponible(ServicioNoDisponibleException ex, HttpServletRequest request)
    {
