    ...
    public OpenAPI openApi()
    {
        return new OpenAPI()
                .info(new Info()
                        .title("Sucursal API")
                        .version("v1")
                        .description("Microservicio para gestionar las sucursales de cada franquicia. "
                ...
                .tags(List.of(new Tag().name("Sucursales").description("Sucursales que pertenecen a una franquicia")))
