...
{
    @Around("@within(com.levir.hernandez.producto.application.annotation.ObservableUseCase)"
            + " || @annotation(com.levir.hernandez.producto.application.annotation.ObservableUseCase)")
