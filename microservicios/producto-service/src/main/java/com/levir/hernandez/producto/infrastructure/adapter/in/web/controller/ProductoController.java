...
import com.levir.hernandez.producto.infrastructure.adapter.in.web.dto.request.AgregarProductoRequest;
import com.levir.hernandez.producto.infrastructure.adapter.in.web.dto.request.ModificarStockRequest;
import com.levir.hernandez.producto.infrastructure.adapter.in.web.dto.request.NombreRecursoRequest;
...
public class ProductoController
{
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "503", description = "El servicio de sucursales no esta disponible", content = @Content)
    })
