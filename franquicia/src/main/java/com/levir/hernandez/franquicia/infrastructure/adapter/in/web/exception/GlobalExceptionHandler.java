...
{
    // Franquicia, sucursal o producto inexistente
    ...
    // La franquicia o sucursal a la que se asocia el nuevo recurso no existe (falla la llave foranea)
    @ExceptionHandler(DataIntegrityViolationException.class)
    public ResponseEntity<ErrorResponse> padreNoEncontrado(DataIntegrityViolationException ex, HttpServletRequest request)
    {
        return build(HttpStatus.NOT_FOUND, "El recurso al que se quiere asociar no existe", request, List.of());
    }
