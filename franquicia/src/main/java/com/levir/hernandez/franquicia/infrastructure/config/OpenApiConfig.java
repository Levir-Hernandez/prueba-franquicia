...
public class OpenApiConfig
{
    ...
    public OpenAPI franquiciaOpenApi()
    {
        return new OpenAPI()
                ...
                .tags(List.of(
                        new Tag().name("Franquicias").description("Creacion, consulta y renombrado de franquicias"),
                        new Tag().name("Sucursales").description("Sucursales que pertenecen a una franquicia"),
                        new Tag().name("Productos").description("Productos de una sucursal y su stock")
                ))
